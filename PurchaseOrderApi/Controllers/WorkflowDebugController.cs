    ...
    IBookmarkStore bookmarks) : ControllerBase
{
    ...
    {
        var all = await instances.FindManyAsync(new WorkflowInstanceFilter(), ct);
    ...
    {
        var bms = await bookmarks.FindManyAsync(new BookmarkFilter(), ct);
